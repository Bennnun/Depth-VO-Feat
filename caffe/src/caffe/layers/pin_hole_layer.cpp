...
void PinHoleLayer<Dtype>::Reshape(const vector<Blob<Dtype> *> &bottom,
...
template <typename Dtype>
void PinHoleLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype> *> &bottom,
                                      const vector<Blob<Dtype> *> &top) {
  std::cout << "PinHoleLayer Warning: Running Forward_gpu() code instead"
            << std::endl;
...
void PinHoleLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype> *> &top,
  ...
  std::cout << "PinHoleLayer Warning: Running Backward_gpu() code instead"
            << std::endl;
